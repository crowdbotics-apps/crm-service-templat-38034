...
## Project Structure
    ...
    ├── crm_service_templat_38034  # Django project configurations
...
1. Clone this repo and `cd crm_service_templat_38034`
...
2. Clone this repo and `cd crm_service_templat_38034`
